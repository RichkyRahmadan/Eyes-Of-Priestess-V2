package com.eyesofpriestess.covenant.entity;
...
/**
 * Covenant — Escrow Room entity.
 * Represents a sacred escrow agreement between two Pilgrims (Buyer & Seller).
 *
 * State Machine:
 ...
 */
@Entity
@Table(name = "covenants", schema = "covenant")
public class Covenant extends PanacheEntityBase {
