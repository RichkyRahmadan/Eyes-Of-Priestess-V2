...
/**
 * Transaction — Immutable transaction record for every Wallet movement.
 * The sacred audit log — once created, never modified.
 * Schema: vault.transactions
 */
@Entity
...
public class Transaction extends PanacheEntityBase {
    ...
    public String type;
    // TopUpOrder | WITHDRAWAL | TITHING_IN | TITHING_OUT
    ...
    // Factory
    public static Transaction record(UUID treasuryId, String type, BigDecimal amount,
