...
/**
 * TopUpOrder — Top-up request via Xendit (VA, QRIS, eWallet).
 * Status lifecycle: PENDING → ACCEPTED | EXPIRED | CANCELLED | FAILED
 * Schema: vault.topUpOrders
 */
@Entity
@Table(schema = "wallet", name = "topUpOrders")
public class TopUpOrder extends PanacheEntityBase {
