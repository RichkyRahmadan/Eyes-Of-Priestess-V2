package com.eyesofpriestess.judgment.entity;
...
/**
 * JudgmentCase — A dispute case opened when a Covenant enters DISPUTED status.
 *
 * State machine:
 ...
 */
@Entity
@Table(name = "judgment_cases", schema = "judgment")
public class JudgmentCase extends PanacheEntityBase {
    ...
    public UUID initiatorId;   // Pilgrim who opened the dispute
